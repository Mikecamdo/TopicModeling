...
def extract_documents():
    for i in range (1, 51): 
        with open('./Articles/' + str(i) + '.txt', 'rb') as file:
...
# Below we remove words that appear in less than 5 documents or in more than
...
top_topics = model.top_topics(corpus, topn=25)
...
for doc in corpus:
    ...
    document_topics = model.get_document_topics(doc)
